...
public class Isci extends Personel{
    ...
    public static void main(String[] args) {
        ...
        Isci isci1=new Isci();
        System.out.println("Isim : "+isci1.isim);//Belirtilmedi
        //kendi class'imizda isim variable yok.
        // bu nedenle parent class'dan alir
        System.out.println("Isim : "+(isci1.isim = "Selim"));
        System.out.println(isci1.persNo);//1001 -kendi class'inda
        // varsa onu kullanir

        isci1.maas();//Isciler min. 15 uero saat ucreti alir
    ...
    public void maas(){
        System.out.println("Isciler min. 15 uero saat ucreti alir");
    }
public void ozelSigorta(){
    System.out.println("Iscilerden isteyene %50 indirimli" +
            "ozel sigorta yapilir");
}
